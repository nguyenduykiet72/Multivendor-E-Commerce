      ...
      <div className="flex flex-wrap w-full">
        <div className="w-full lg:w-7/12 ">
          <div className="w-full p-4 bg-white rounded-md">
                ...
                <tbody>
                  {[1, 2, 3, 4, 5].map((k, index) => (
                    <tr key={index}>
                      ...
                      <td
                        scope="row"
                        className="flex items-center justify-center px-4 py-2 font-medium whitespace-nowrap"
                      >
                        <img
            ...
            <div className="flex justify-end w-full pr-6 mt-4 bottom-4 right-4">
              <Pagination
        ...
        <div
          ...
          } z-20 top-0 transition-none duration-500`}
        >
            ...
            <div className="h-screen px-3 py-2 bg-white lg:h-auto lg:rounded-md">
              ...
              <form action="">
                ...
                <div>
                  ...
                  />
                  <div>
                    <button className="w-full bg-[#fc334d]  hover:shadow-red-500/50 hover:shadow-sm rounded-md px-7 py-2 my-2">
                      Add Product
                    </button>
                  </div>
                </div>
