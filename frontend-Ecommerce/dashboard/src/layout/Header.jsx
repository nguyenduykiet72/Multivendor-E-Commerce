    ...
    <div className="fixed top-0 left-0 z-40 w-full px-2 py-5 lg:px-7">
      <div className="ml-0 lg:ml-[260px] rounded-md h-[65px] flex justify-between items-center font-sans bg-white px-5 transition-all">
        <div
          ...
          className="w-[35px] flex lg:hidden h-[35px] rounded-sm bg-[#4bd9ac] shadow-lg hover:shadow-teal-500/50 justify-center items-center cursor-pointer"
        >
          <span>
            <FaList />
          </span>
        ...
        <div className="hidden md:block">
          <input
            type="text"
            className="px-3 py-2 bg-transparent border rounded-md outline-none border-slate-500 text-[#000000] focus:border-teal-500 overflow-hidden"
            name="search"
            placeholder="search"
          />
        </div>
        ...
        <div className="relative flex items-center justify-center gap-8">
          <div className="flex items-center justify-center">
            <div className="flex items-center justify-center gap-3">
              ...
              <img className="w-[45px] h-[45px]" src="../../public/images/admin.png" alt="" />
            </div>
          </div>
        </div>
      </div>
